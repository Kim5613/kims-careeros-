...
const ITEMS = [
  { key: 'talent', icon: '🎯', title: '人才弹药库', desc: '人才档案 · 人才分类 · 人才运营', route: '/talent' },
  { key: 'companies', icon: '🏢', title: '公司瞭望台', desc: '公司档案 · 人才分布 · 公司运营', route: '/companies' },
];
  ...
  return (
    <div style={{ padding: '40px 48px 24px', background: '#faf8f6', minHeight: '100vh' }}>
      <div style={{ marginBottom: 28 }}>
        <Title level={3} style={{ margin: 0, fontSize: 20, fontWeight: 600 }}>💼 工作资产</Title>
        <Text type="secondary" style={{ marginTop: 4, display: 'block' }}>
          HR 工作资产系统 — 人才管理 · 公司情报 · 市场洞察
        </Text>
      </div>
      <Row gutter={[16, 16]}>
        {ITEMS.map((item) => (
